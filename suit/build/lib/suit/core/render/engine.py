...
#        if self.__rootSheet:
#            self.__rootSheet.mouseMoved(evt)
...
#        if self.__rootSheet:
#            self.__rootSheet.mousePressed(evt, _id)
...
#        if self.__rootSheet:
#            self.__rootSheet.mouseReleased(evt, _id)
        if not _kernel._arg_mode:
...
#        # check backspace to go parent sheet
#        if evt.key == ois.KC_BACK and self.__rootSheet:
#            if self.__rootSheet.parent is not None:
#                self.setRootSheet(self.__rootSheet.parent)
            
        
        # root sheet
#        if self.__rootSheet:
#            self.__rootSheet.keyPressed(evt)
    ...
    def keyReleased(self, evt):
        ...
        # root sheet
#        if self.__rootSheet:
#            self.__rootSheet.keyReleased(evt)
