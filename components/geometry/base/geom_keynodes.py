...
class Objects:
    ...
    point       =   session.find_keynode_full_uri(u"/seb/planimetry/геометрическая точка")
...
class Relation:
    nrel_border_point   =   session.find_keynode_full_uri(u"/seb/planimetry/граничная точка_") 
    nrel_center         =   session.find_keynode_full_uri(u"/seb/planimetry/центр*")
    nrel_triangle_side  =   session.find_keynode_full_uri(u"/seb/planimetry/сторона*")
