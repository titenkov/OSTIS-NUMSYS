...
class ChoiceControl:
    ...
    def _createWidget(self):
        ...
        """
        self.panel = self.parent.createWidgetT("Window", "Panel", mygui.IntCoord(0, 0, 10, 10),
                                                       mygui.Align())
    ...
    def _create_value_widgets(self):
        ...
        for value in self.values:
            widget = self.panel.createWidgetT("Button", "Button", 
                                              mygui.IntCoord(2, (len(self.widgets)* 20 + 2), self.width - 5, 20),
                                              mygui.Align())
        ...
        self.panel.setSize(self.width, len(self.widgets) * 20 + 5)
...
class TypeChanger:
    ...
    def createPanel(self):
        ...
        self.panel = render_engine.Gui.createWidgetT("Window", "Panel", mygui.IntCoord(0, 0, 10, 10), 
                                                     mygui.Align(), "Info", "")
        self.button_ok = self.panel.createWidgetT("Button", "Button", mygui.IntCoord(0, 0, 50, 20), mygui.Align())
        self.button_cancel = self.panel.createWidgetT("Button", "Button", mygui.IntCoord(0, 0, 50, 20), mygui.Align())
    ...
    def run(self):
        ...
        self.button_ok.setPosition(3, height + 10)
        self.button_cancel.setPosition(56, height + 10)
...
class ContentChanger:
    ...
    def createPanel(self):
        ...
        self.panel = render_engine.Gui.createWidgetT("Window", "Panel", mygui.IntCoord(0, 0, self.width, self.height), 
                                                     mygui.Align(), "Info", "")
        self.types_list = self.panel.createWidgetT("List", "List", mygui.IntCoord(5, 5, self.width - 10, 175), mygui.Align())
        self.types_list.subscribeEventChangePosition(self, 'item_selected')
        
        self.button_ok = self.panel.createWidgetT("Button", "Button", mygui.IntCoord(5, self.height - 25, 50, 20), mygui.Align())
        self.button_cancel = self.panel.createWidgetT("Button", "Button", mygui.IntCoord(60, self.height - 25, 50, 20), mygui.Align())
        ...
        self.checkbox_edit = self.panel.createWidgetT("Button", "CheckBox", mygui.IntCoord(5, 185, self.width - 10, 22), mygui.Align())
